...
public class PduCountConfiguration extends Configuration
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	// Analyzer Enumeration Usage
	public static final String KEY_ENUM_ORDER_BY   = "disassembler.analyzer.pducount.orderby";
	public static final String KEY_ENUM_ASCENDING  = "disassembler.analyzer.pducount.ascending";
	public static final String KEY_ENUM_FILTER     = "disassembler.analyzer.pducount.filterby";
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public PduCountConfiguration( String[] commandline )
	{
		super( commandline );
	}
