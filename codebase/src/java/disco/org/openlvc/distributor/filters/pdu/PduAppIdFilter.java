...
public class PduAppIdFilter extends AbstractFilter implements IFilter
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	public static final String FILTER_KEY = "pdu.appId";
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public PduAppIdFilter( Operator operator, String value )
	{
		super( FILTER_KEY, operator, value );
		this.appId = Short.parseShort( value );
	}
	...
	{
		return operator.compare( appId, pdu.getAppId() );
	}
