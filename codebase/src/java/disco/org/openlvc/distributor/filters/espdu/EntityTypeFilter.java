...
public class EntityTypeFilter extends AbstractEntityStateFilter implements IFilter
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	public static final String FILTER_KEY = "entity.type";
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public EntityTypeFilter( Operator operator, String value )
	{
		super( FILTER_KEY, operator, value );
		this.pattern = Wildcards.forEnumeration( value );
	}
	...
	public final boolean matches( PDU pdu )
	{
		...
		String incoming = espdu.getEntityType().toString();
