...
public class Configuration
{
	...
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	public static final String KEY_CONFIG_FILE        = "disillusion.configfile";
	public static final String KEY_LOG_LEVEL          = "disillusion.loglevel";
	public static final String KEY_LOG_FILE           = "disillusion.logfile";

	public static final String KEY_OBJECT_COUNT       = "disillusion.objectCount";
	public static final String KEY_LOOPS              = "disillusion.loops";
	public static final String KEY_TICK_INTERVAL      = "disillusion.tickInterval";

	public static final String KEY_SIMULATION_ADDRESS = "disillusion.dis.simaddress";

	public static final String KEY_DISCO_LOG_LEVEL    = "disillusion.disco.loglevel";
	public static final String KEY_DISCO_ADDRESS      = "disillusion.dis.address";
	public static final String KEY_DISCO_PORT         = "disillusion.dis.port";
	public static final String KEY_DISCO_NIC          = "disillusion.dis.nic";
	public static final String KEY_DISCO_EXID         = "disillusion.dis.exerciseId";
	...
	public Configuration( String[] args )
	{
		...
		this.loggingConfiguration = new Log4jConfiguration( "disillusion" );
	...
	public Logger getDisillusionLogger()
	{
		...
		this.applicationLogger = LogManager.getFormatterLogger( "disillusion" );
		return applicationLogger;
	}
	...
	{
		System.out.println( "Disillusion - Load testing tool for DIS applications" );
