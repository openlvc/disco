 ...
 */
public class RawEnumValue32 implements ExtendedDataElement<RawEnumValue32>
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	@Override
	public RawEnumValue32 valueOf( ByteWrapper wrapper ) throws DecoderException
	{
	...
	@Override
	public RawEnumValue32 valueOf( byte[] bytes ) throws DecoderException
	{
		value.decode( bytes );
		return this;
	}
