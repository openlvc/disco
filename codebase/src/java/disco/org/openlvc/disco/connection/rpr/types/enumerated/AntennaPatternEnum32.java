...
public enum AntennaPatternEnum32 implements ExtendedDataElement<AntennaPatternEnum32>
{
	//----------------------------------------------------------
	//                        VALUES
	//----------------------------------------------------------
	...
	@Override
	public AntennaPatternEnum32 valueOf( ByteWrapper value ) throws DecoderException
	{
	...
	@Override
	public AntennaPatternEnum32 valueOf( byte[] value ) throws DecoderException
	{
		RPRunsignedInteger32BE temp = new RPRunsignedInteger32BE();
		temp.decode( value );
		return valueOf( temp.getValue() );
