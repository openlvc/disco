 ...
 * @param <T>
 */
public class RPRlengthlessFixedArray<T extends DataElement> extends HLAfixedArray<T>
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public RPRlengthlessFixedArray( DataElementFactory<T> factory, int size )
	{
		super( factory, size );
	}
