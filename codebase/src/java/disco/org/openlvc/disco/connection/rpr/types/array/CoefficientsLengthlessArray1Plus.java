...
public class CoefficientsLengthlessArray1Plus extends RPRlengthlessArray<HLAfloat32BE>
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	private static class Factory implements DataElementFactory<HLAfloat32BE>
	{
    	@Override
    	public HLAfloat32BE createElement( int index )
    	{
    		return new HLAfloat32BE();
    	}
	}
