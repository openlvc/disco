...
public enum TransmitterOperationalStatusEnum8 implements ExtendedDataElement<TransmitterOperationalStatusEnum8>
{
	//----------------------------------------------------------
	//                        VALUES
	//----------------------------------------------------------
	...
	@Override
	public TransmitterOperationalStatusEnum8 valueOf( ByteWrapper value ) throws DecoderException
	{
	...
	@Override
	public TransmitterOperationalStatusEnum8 valueOf( byte[] value ) throws DecoderException
	{
		HLAoctet temp = new HLAoctet();
		temp.decode( value );
		return valueOf( temp.getValue() );
