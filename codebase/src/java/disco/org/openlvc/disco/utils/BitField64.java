...
public class BitField64
{
	...
	public long getBits( int start, int end )
	{
	...
	{
		return String.format("%32s", Long.toBinaryString(bits)).replace( ' ', '.' ) ;
	}
	 ...
	 * param) set to true.
	 * 
	 * @param field     The long to look at the bits for
	 * @param position  The position to look at bits for
	 * @return          True if the bit is 1, false otherwise.
	 */
	public static boolean isSet( long field, int position )
	{
	 ...
	 */
	public static long set( long field, int position, boolean on )
	{
		if( on )
	 ...
	 */
	public static long getSubfield( long field, int start, int end )
	{
		int amount = (end-start)+1;
		return (((1 << amount) - 1) & (field >> (start - 1)));	
	}
	 ...
	 */
	public static long setSubfield( long field, int value, int start, int end )
	{
