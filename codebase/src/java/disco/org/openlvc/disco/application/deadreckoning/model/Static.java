...
/**
 * An implementation of the 'STATIC' dead-reckoning model described in 1278.1-2012 Annex E. The
 * standard recommends the use of this model for "Static entities".
 */
public class Static extends DeadReckoningModel
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public Static( IDeadReckoningEnabled object )
	{
		super( object );
	}
	...
	{
		return DeadReckoningAlgorithm.Static;
	}
