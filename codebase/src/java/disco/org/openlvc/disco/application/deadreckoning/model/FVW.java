...
/**
 * An implementation of the 'DRM (FVW)' dead-reckoning model described in 1278.1-2012 Annex E. The
 * standard recommends the use of this model for "High speed (e.g., missile) or maneuvering at any
 * speed".
 * <ul>
 ...
 * </ul>
 */
public class FVW extends DeadReckoningModel
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                      CONSTRUCTORS
	//----------------------------------------------------------
	public FVW( IDeadReckoningEnabled object )
	{
		super( object );
	}
	...
	{
		return DeadReckoningAlgorithm.FVW;
	}
