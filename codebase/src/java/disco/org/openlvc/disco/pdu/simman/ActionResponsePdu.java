...
public class ActionResponsePdu extends PDU
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	{
		super( PduType.ActionResponse, ProtocolFamily.SimMgmt );
		this.requestId = 0;
		this.requestStatus = RequestStatus.Other;
	...
	public void from( DisInputStream dis ) throws IOException
	{
		...
		this.requestStatus = RequestStatus.fromValue( dis.readUI32() );
	...
	public void to( DisOutputStream dos ) throws IOException
	{
		...
		dos.writeUI32( this.requestStatus.value() );
	...
	public int getContentLength()
	{
		...
		size += DisSizes.UI32_SIZE; // RequestStatus             // 4
